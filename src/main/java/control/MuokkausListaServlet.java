...
@WebServlet("/muokkaus-lista")

public class MuokkausListaServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/muokkauslista.jsp").forward(request, response);
		request.getRequestDispatcher("/WEB-INF/vaatteenmuokkauslista.jsp").forward(request, response);	
	}
}
