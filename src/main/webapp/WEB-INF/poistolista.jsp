...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8">
				<h2>Poista tuotteita</h2>
				<p style="display:inline">Voit poistaa omia tuotteitasi</p>
				<span class="button" id="btn2"><a href="/muokkaus-lista" >Muokkaa tuotteita</a></span>
					...
					<table>
						...
						<c:forEach items="${vaatelista}" var="vaate">
							<tr>
								...
								<td><button><a id="poista" href="/poista-vaate?vaateid=<c:out value='${vaate.id}'/>">Poista</a></button></td>
							<tr>
						</c:forEach>
					</table>
					<table>
						...
						<c:forEach items="${tuotelista}" var="tuote">
							<tr>
								...
								<td><button><a id="poista" href="/poista-tuote?tuoteid=<c:out value='${tuote.id}'/>">Poista</a></button></td>
							<tr>
						</c:forEach>
					</table>
				</div>
